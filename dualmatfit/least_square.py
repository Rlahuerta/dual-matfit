...
from dualmatfit.extension_solution import ExtensionSolution, DesignVariablesMixin
from dualmatfit.derivative import _fdm, adjoint_derivative
from dualmatfit.cost_cache import CostCache, LimitedOrderedDict
from dualmatfit.numeric_utils import sanitize_array, has_nan, is_finite, safe_divide
from dualmatfit.regularization import (
    L2Regularization,
    VolumeRegularization,
    CompositeRegularization,
)
from dualmatfit.cost_functions import (lsq_fval,
                                      lsq_dfval,
                                      ln_fval,
                                      ln_dfval,
                                      ln_lsq_fun,
